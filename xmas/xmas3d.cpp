...
void draw_shape(shape shape,Vec2 pos,float size){
	...
	//std::string text = "screen.line ( " + std::to_string(int (from.x)) + "," + std::to_string(int (from.y)) + ") , (" + std::to_string(int(to.x)) + "," + std::to_string(int(to.y)) + " ) ";
	//screen.text(text, minimal_font, Vec2(0,50), true);
